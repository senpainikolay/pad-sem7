...
class PoliceReportingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                ...
                request_serializer=proto_dot_police__pb2.HealthRequest.SerializeToString,
                response_deserializer=proto_dot_police__pb2.HealthResponse.FromString,
                )
...
def add_PoliceReportingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_police__pb2.HealthRequest.FromString,
                    response_serializer=proto_dot_police__pb2.HealthResponse.SerializeToString,
            ),
    }
...
class PoliceReportingService(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/proto.PoliceReportingService/HealthCheck',
            proto_dot_police__pb2.HealthRequest.SerializeToString,
            proto_dot_police__pb2.HealthResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
